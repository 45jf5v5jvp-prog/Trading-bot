  ...
  return (
    <div>
      ...
      <div className="field-inline">
        ...
        <input type="number" min="0" value={launch.perLaunchPls} onChange={set("perLaunchPls")} style={{ width: 100 }} />
        <label>Max buys/day</label>
        <input type="number" min="0" value={launch.maxPerDay} onChange={set("maxPerDay")} style={{ width: 80 }} />
      </div>

      <div className="field-inline">
        <label>Take profit %</label>
        <input type="number" min="0" value={launch.takeProfitPct} onChange={set("takeProfitPct")} style={{ width: 80 }} />
        <label>Stop loss %</label>
        <input type="number" min="0" value={launch.stopLossPct} onChange={set("stopLossPct")} style={{ width: 80 }} />
        <label>Time exit (min)</label>
        <input type="number" min="0" value={launch.timeExitMin} onChange={set("timeExitMin")} style={{ width: 80 }} />
      </div>
      ...
      <div className="field-inline">
        ...
        <input type="number" min="0" value={launch.maxBuyTaxBps} onChange={set("maxBuyTaxBps")} style={{ width: 90 }} />
        <label>Max sell tax (bps)</label>
        <input type="number" min="0" value={launch.maxSellTaxBps} onChange={set("maxSellTaxBps")} style={{ width: 90 }} />
      </div>
      ...
      <div className="field-inline">
        ...
        <input type="number" min="0" value={launch.maxDeployerPct} onChange={set("maxDeployerPct")} style={{ width: 80 }} />
        <label>Min liquidity (PLS)</label>
        <input type="number" min="0" value={launch.minLiquidityPls} onChange={set("minLiquidityPls")} style={{ width: 110 }} />
      </div>
    </div>
  );
}
