...
export const provider = new JsonRpcProvider(CFG.rpcUrl, { chainId: CFG.chainId, name: "robinhood-chain" });
...
export async function verifyChain(): Promise<void> {
  ...
  log("info", "chain", `Connected to Robinhood Chain, router and factory agree`);
}
