...
const PRESETS = {
  ...
  robinhood: {
    ...
    // Icaria's V2 detection (it also tries V3/V4 - see lib/askIcaria.js)
    // simply has no V2 factory wired up here rather than trusting a guessed
    // address, per this project's "no fabricated defaults" convention.
    factory: "",
