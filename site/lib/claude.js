...
function describeProfile(p) {
  const lines = [
    ...
    p.lpLockUnverifiable
      ? "LP locked or burned: cannot be verified for this venue (V3/V4 liquidity isn't a checkable token balance)"
...
const SYSTEM_PROMPT =
  "You assess Robinhood Chain (Uniswap) tokens for a trading bot's users, answering a question the " +
