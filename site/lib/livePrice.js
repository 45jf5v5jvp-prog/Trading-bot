 ...
 * the vault's actual on-chain balance (decimals-correct - HEX is 8 decimals,
 * not the 18 the rest of this app assumes for fresh launch tokens) and what
 * that balance is worth right now. A quote or balance failure returns nulls
 * rather than throwing, so one bad/illiquid token doesn't blank the panel.
 */
