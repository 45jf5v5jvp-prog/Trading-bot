 ...
 * (a live router quote, not a cached price), and whether that's up or down
  ...
  return (
    <div className="holding-card">
      ...
      <div className="holding-meta">
        Spent {p.spent_pls.toLocaleString()} ETH
        {p.valueNowPls !== null && p.valueNowPls !== undefined
          ? ` · worth ${p.valueNowPls.toLocaleString(undefined, { maximumFractionDigits: 6 })} ETH now`
          : ""}
      </div>
      ...
      {positions.closed.length > 0 && (
        <>
          ...
          <div className="table-wrap">
            <table>
              <thead><tr><th>Bot</th><th>Token</th><th>Closed</th><th>Proceeds (ETH)</th><th>Reason</th></tr></thead>
              <tbody>
